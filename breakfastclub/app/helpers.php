...
if (! function_exists('app_details')) {
    /**
     * Helper to grab the application details
     *
     * @return mixed
     */
    function app_details()
    {
        $details=array(
            ...
            'company_contact'   => config('app.company_contact'),
            'company_website'   => config('app.company_website'),
            'company_logo_link' => config('app.company_logo_link')
        );
